...
const ShowSneakersItem = ({props}) => {
  return (
    <div>
      <h2>{props.name}</h2>
      <div className={styles.MainPartSneaker}>
        <img src={props.img} alt="" />
        <div className={styles.PartSneakerInner}>
          <div className={styles.PartSneakerText}>
            <p>{props.price} руб.</p>
            <button>
          ...
          <div className={styles.addingBtn}>
            <button>
              add to Card
            </button>
          </div>
...
export default ShowSneakersItem;